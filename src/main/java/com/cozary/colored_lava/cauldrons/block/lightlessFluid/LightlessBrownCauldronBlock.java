...
public class LightlessBrownCauldronBlock extends PreBaseCauldronBlock {
    public static final IntegerProperty LEVEL = BlockStateProperties.LEVEL_CAULDRON;

    public LightlessBrownCauldronBlock() {
        super(Properties.copy(Blocks.CAULDRON).noOcclusion(),
                LightlessCauldronBehavior.LIGHTLESS_BROWN_CAULDRON_BEHAVIOR);
