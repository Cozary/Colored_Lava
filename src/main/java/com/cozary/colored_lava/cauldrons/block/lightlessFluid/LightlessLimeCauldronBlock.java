...
public class LightlessLimeCauldronBlock extends PreBaseCauldronBlock {
    public static final IntegerProperty LEVEL = BlockStateProperties.LEVEL_CAULDRON;

    public LightlessLimeCauldronBlock() {
        super(Properties.copy(Blocks.CAULDRON).noOcclusion(),
                LightlessCauldronBehavior.LIGHTLESS_LIME_CAULDRON_BEHAVIOR);
