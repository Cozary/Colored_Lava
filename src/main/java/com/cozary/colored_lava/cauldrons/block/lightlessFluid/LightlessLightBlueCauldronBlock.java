...
public class LightlessLightBlueCauldronBlock extends PreBaseCauldronBlock {
    public static final IntegerProperty LEVEL = BlockStateProperties.LEVEL_CAULDRON;

    public LightlessLightBlueCauldronBlock() {
        super(Properties.copy(Blocks.CAULDRON).noOcclusion(),
                LightlessCauldronBehavior.LIGHTLESS_LIGHT_BLUE_CAULDRON_BEHAVIOR);
