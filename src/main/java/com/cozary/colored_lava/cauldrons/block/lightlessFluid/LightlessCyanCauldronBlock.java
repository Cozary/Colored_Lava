...
public class LightlessCyanCauldronBlock extends PreBaseCauldronBlock {
    public static final IntegerProperty LEVEL = BlockStateProperties.LEVEL_CAULDRON;

    public LightlessCyanCauldronBlock() {
        super(Properties.copy(Blocks.CAULDRON).noOcclusion(),
                LightlessCauldronBehavior.LIGHTLESS_CYAN_CAULDRON_BEHAVIOR);
